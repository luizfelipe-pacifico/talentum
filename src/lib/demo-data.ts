...
export const NAV: NavEntry[] = [
  { href: '/', icon: 'bi-house-door', label: 'Início' },
  { href: '/extratos', icon: 'bi-receipt', label: 'Extratos' },
  { href: '/conciliacao', icon: 'bi-check2-square', label: 'Conciliação', badge: '4' },
...
export const PAGE_META: { prefix: string; title: string; context: string }[] = [
  ...
  { prefix: '/conciliacao', title: 'Conciliação financeira', context: '4 itens aguardando decisão' },
  { prefix: '/patrimonio', title: 'Patrimônio e metas', context: 'Carteira de R$ 40.000,00 em quatro pilares' },
...
export const CONTAS: { label: string; saldo: string }[] = [
  { label: 'Todas as contas', saldo: 'R$ 8.412,60' },
  { label: 'Conta corrente Aurora', saldo: 'R$ 4.312,80' },
  { label: 'Poupança Aurora', saldo: 'R$ 2.150,00' },
  { label: 'Carteira digital Vega', saldo: 'R$ 1.949,80' },
];
